...
class CabinetPaperController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.cabinetPapers.index', compact('cabinetPapers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.cabinetPapers.create');
    }
    ...
    public function store(StoreCabinetPaperRequest $request)
    {
        ...
        return redirect()->route('frontend.cabinet-papers.index');
    }
    ...
    public function edit(CabinetPaper $cabinetPaper)
    {
        ...
        return view('frontend.cabinetPapers.edit', compact('cabinetPaper'));
    }
    ...
    public function show(CabinetPaper $cabinetPaper)
    {
        ...
        return view('frontend.cabinetPapers.show', compact('cabinetPaper'));
    }
