    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cabinet-papers.update", [$cabinetPaper->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cabinet_num" id="cabinet_num" value="{{ old('cabinet_num', $cabinetPaper->cabinet_num) }}" required>
